...
const bodySchema = z.object({
  ...
  network: z.union([z.literal('kovan'), z.literal('mainnet')]),
...
export default async function (req: NextApiRequest, res: NextApiResponse) {
  ...
  const moonPayHost = network === 'mainnet' ? PROD_MOON_PAY_HOST : TEST_MOON_PAY_HOST
  const moonPayKey = network === 'mainnet' ? PROD_MOON_PAY_KEY : TEST_MOON_PAY_KEY
  const moonPaySecretKey =
    network === 'mainnet'
      ? (PROD_MOON_PAY_SECRET_KEY as string)
      : (TEST_MOON_PAY_SECRET_KEY as string)
