...
The Company has developed Fountain.li – an web fronted which displays price and other information relating to digital tokens and assets (“Digital Assets”) that are transacted on the independent OasisDEX protocol and provides the user-interface that guides your access to Fountain.li (the “Services”).
...
### 2.1 Non-Supported Regions

Fountain.li front-end interface is operated by Fountain GmbH based in Liechtenstein. Based on the legal guidance and regulatory interpretations we fully comply with the applicable local and EU law. However, the Fountain.li front-end interface is not intended to be used by users from other jurisdictions. If you are based in a Non-Supported Region, you should exit and look for a local front-end interface to the OasisDEX Protocol which is compliant with the law in your jurisdiction.

The following are Non-Supported Regions as at the date of these Terms of Service. This list may be updated from time-to-time:

Belarus, Burma (Myanmar), Burundi, Central African Republic, Congo, Cote d'Ivoire, Crimea, Cuba, Iran, Iraq, Lebanon, Liberia, Libya, Mali, Nicaragua, North Korea, Somalia, South Sudan, Sudan, Syria, United States of America, Venezuela, Yemen and Zimbabwe.
...
Some software used in our Services may be offered under an open source license that we will make available to you. Documentation of open source code is available on the our GitHub page. This documentation, including any code shown in it, is licensed under the terms shown in the relevant GitHub repository and you agree to abide by the terms of the applicable license.

The “Fountain” and “Fountain.li” names, logos, other related trademarks , and the web domains and URLs are property of th Company and are not covered under the licenses above. Using our Services does not give you ownership of any proprietary intellectual property rights in our Services or the content you access. You may not use proprietary content from our Services unless you obtain permission from its owner or are otherwise permitted by law. These terms do not grant you the right to use any branding or logos used in our Services. You may not remove, obscure, or alter any legal notices displayed in or along with our Services.
...
## 12. Prohibited Use
  ...
  * You may not use the Service to engage in the following categories of activity (" Prohibited Uses "). The specific types of use listed below are representative, but not exhaustive. If you are uncertain as to whether or not your use of the Services involves a Prohibited Use, or have questions about how these requirements apply to you, please contact us at legal@fountain.li. By using the Site or Services, you confirm that you will not use the Site or Services to do any of the following:
...
Users with questions, complaints or claims with respect to the Services may contact us using the relevant contact information set forth above and at legal@fountain.li.
`
