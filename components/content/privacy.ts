...
### IP Address and Related Geolocation Data

We use third party services to determine the likely geographical location of visitors by their IP address in order to ensure that Fountain.li is not available to users from Non-Supported Regions. To accomplish this we also screen IP addresses that are determined by third party services as being likely to be Virtual Private Networks, Proxy Servers, TOR exit nodes or similar services which may mask a user’s geographic location.

The legal basis for this processing is that it is necessary to ensure that visitors from Non-Supported Regions cannot use the full functionality of the Site due to local or international regulations and requirements.
...
You may contact us by email to the following email address: legal@fountain.li. We use the data that you provide in an email to us, which you may give voluntarily, only in order to answer your contact question or to reply to your email in the best possible manner.
