...
import { MoonpayOrder, WyreOrder } from 'components/dashboard/onrampOrders'
import { TxTranslator } from 'components/transactionManager/transactionManager'
...
export function getTransactionTranslations(tx: TxMgrTransaction) {
  ...
  if (kind === 'blockchain') {
    ...
    return {
      ...
      notification: (
        <Flex sx={{ alignItems: 'center ' }}>
          <Icon name="wyre" size="auto" width="20" height="20" mr={2} />
    ...
    return {
      ...
      notification: (
        <Flex sx={{ alignItems: 'center ' }}>
          <Icon name="moonpay" size="auto" width="20" height="20" mr={2} />
